...
hi! ColorColumn cterm=NONE gui=NONE ctermbg=235 guibg=#323232
hi! CursorColumn cterm=NONE gui=NONE ctermbg=235 guibg=#323232
hi! CursorLine cterm=NONE gui=NONE ctermbg=235 guibg=#323232
hi! Comment cterm=italic gui=italic ctermfg=242 guifg=#505050
hi! Constant cterm=NONE gui=NONE ctermfg=209 guifg=#eb882d
...
hi! DiffText cterm=NONE gui=NONE ctermbg=24 ctermfg=233 guibg=#5b7881 guifg=#151515
hi! Directory cterm=NONE gui=NONE ctermfg=203 guifg=#e95678
hi! Error cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! ErrorMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! WarningMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! EndOfBuffer cterm=NONE gui=NONE ctermbg=233 ctermfg=236 guibg=#151515 guifg=#323232
hi! NonText cterm=NONE gui=NONE ctermbg=233 ctermfg=233 guifg=#323232 guibg=#151515
hi! SpecialKey cterm=NONE gui=NONE ctermbg=203 ctermfg=235 guibg=#e95678 guifg=#323232
hi! Folded cterm=NONE gui=NONE ctermbg=233 ctermfg=242 guibg=#151515 guifg=#2d2d2d
...
hi! Normal cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guibg=#151515 guifg=#f1f6fb
hi! Operator cterm=NONE gui=NONE ctermfg=37 guifg=#2f93fc
hi! Pmenu cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guifg=#151515 guibg=#f1f6fb
...
hi! PmenuThumb cterm=NONE gui=NONE ctermbg=233 guibg=#151515
hi! PreProc cterm=NONE gui=NONE ctermfg=150 guifg=#3cef85
hi! Question cterm=NONE gui=NONE ctermfg=150 guifg=#3cef85
hi! QuickFixLine cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guibg=#272c42 guifg=#151515
hi! Search cterm=NONE gui=NONE ctermbg=216 ctermfg=234 guibg=#e4aa80 guifg=#392313
hi! SignColumn cterm=NONE gui=NONE ctermbg=233 ctermfg=242 guibg=#151515 guifg=#2d2d2d
...
hi! SpellRare cterm=undercurl gui=undercurl ctermbg=97 ctermfg=252 guisp=#eb882d
...
hi! ALEErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! ALEWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#151515 guifg=#fcd148
...
hi! GitGutterAdd cterm=NONE gui=NONE ctermbg=233 ctermfg=48 guibg=#151515 guifg=#3cef85
hi! GitGutterChange cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#151515 guifg=#e95678
hi! GitGutterChangeDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#151515 guifg=#e95678
hi! GitGutterDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! Sneak cterm=NONE gui=NONE ctermbg=140 ctermfg=234 guibg=#eb882d guifg=#e95678
hi! SneakScope cterm=NONE gui=NONE ctermbg=236 ctermfg=242 guibg=#272c42 guifg=#f1f6fb
hi! SyntasticErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! SyntasticStyleErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#151515 guifg=#ec456b
hi! SyntasticStyleWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#151515 guifg=#fcd148
hi! SyntasticWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#151515 guifg=#fcd148
