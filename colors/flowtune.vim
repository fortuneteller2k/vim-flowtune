...
hi! ColorColumn cterm=NONE gui=NONE ctermbg=235 guibg=#1e1e1e
hi! CursorColumn cterm=NONE gui=NONE ctermbg=235 guibg=#1e1e1e
hi! CursorLine cterm=NONE gui=NONE ctermbg=235 guibg=#1e1e1e
hi! Comment cterm=italic gui=italic ctermfg=242 guifg=#2d2d2d
...
hi! DiffText cterm=NONE gui=NONE ctermbg=24 ctermfg=233 guibg=#5b7881 guifg=#1a1a1a
hi! Directory cterm=NONE gui=NONE ctermfg=203 guifg=#e95678
hi! Error cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! ErrorMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! WarningMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! EndOfBuffer cterm=NONE gui=NONE ctermbg=233 ctermfg=236 guibg=#1a1a1a guifg=#1e1e1e
hi! NonText cterm=NONE gui=NONE ctermbg=233 ctermfg=233 guifg=#1e1e1e guibg=#1a1a1a
hi! SpecialKey cterm=NONE gui=NONE ctermbg=203 ctermfg=235 guibg=#e95678 guifg=#1e1e1e
hi! Folded cterm=NONE gui=NONE ctermbg=233 ctermfg=242 guibg=#1a1a1a guifg=#6c6f93
hi! FoldColumn cterm=NONE gui=NONE ctermbg=233 ctermfg=242 guibg=#1a1a1a guifg=#6c6f93
...
hi! LineNr cterm=NONE gui=NONE ctermbg=233 ctermfg=239 guibg=#1a1a1a guifg=#6c6f93
...
hi! Normal cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guibg=#1a1a1a guifg=#f1f6fb
hi! Operator cterm=NONE gui=NONE ctermfg=37 guifg=#2f93fc
hi! Pmenu cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guifg=#1a1a1a guibg=#f1f6fb
...
hi! PmenuThumb cterm=NONE gui=NONE ctermbg=233 guibg=#1a1a1a
hi! PreProc cterm=NONE gui=NONE ctermfg=150 guifg=#3cef85
hi! Question cterm=NONE gui=NONE ctermfg=150 guifg=#3cef85
hi! QuickFixLine cterm=NONE gui=NONE ctermbg=233 ctermfg=252 guibg=#272c42 guifg=#1a1a1a
hi! Search cterm=NONE gui=NONE ctermbg=216 ctermfg=234 guibg=#e4aa80 guifg=#392313
hi! SignColumn cterm=NONE gui=NONE ctermbg=233 ctermfg=242 guibg=#1a1a1a guifg=#6c6f93
...
hi! ALEErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! ALEWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#1a1a1a guifg=#fcd148
...
hi! GitGutterAdd cterm=NONE gui=NONE ctermbg=233 ctermfg=48 guibg=#1a1a1a guifg=#3cef85
hi! GitGutterChange cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#1a1a1a guifg=#e95678
hi! GitGutterChangeDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#1a1a1a guifg=#e95678
hi! GitGutterDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
...
hi! SyntasticErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! SyntasticStyleErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#1a1a1a guifg=#ec456b
hi! SyntasticStyleWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#1a1a1a guifg=#fcd148
hi! SyntasticWarningSign cterm=NONE gui=NONE ctermbg=233 ctermfg=209 guibg=#1a1a1a guifg=#fcd148
...
if has('nvim')
  ...
  let g:terminal_ansi_colors = ['#1a1a1a', '#ec456b', '#3cef85', '#fcd148', '#2f93fc', '#e97b16', '#e95678', '#1a1a1a', '#f1f6fb', '#40c9f2', '#fcd761', '#48a0fc', '#e454f1', '#95c4ce', '#f6f9fd']
endif
